...
void arm_svm_rbf_predict_f16(const arm_svm_rbf_instance_f16* S, const float16_t* in, int32_t* pResult) {
    ...
    while (row >= 4) {
        ...
        vSum = vfmaq_m_f16(vSum, vld1q(pDualCoef), vexpq_f16(vmulq_n_f16(vtmp, -(_Float16)S->gamma)), vctp16q(4));
        pDualCoef += 4;
        pSrcA += numCols * 4;
        /*
    ...
    if (row >= 2) {
        ...
        vSum = vfmaq_m_f16(vSum, vld1q(pDualCoef), vexpq_f16(vmulq_n_f16(vtmp, -(_Float16)S->gamma)), vctp16q(2));
        pDualCoef += 2;
    ...
    if (row >= 1) {
        ...
        vSum = vfmaq_m_f16(vSum, vld1q(pDualCoef), vexpq_f16(vmulq_n_f16(vtmp, -(_Float16)S->gamma)), vctp16q(1));
    }
