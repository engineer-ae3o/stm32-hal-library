...
#define FIR_Q15_MAIN_CORE()                                                                                                                          \
     ...
     */                                                   \
        q15x8_t vecCoeffs[NBVECTAPS];                                                                                                                \
                                                                                                                                                     \
        for (int i = 0; i < NBVECTAPS; i++) vecCoeffs[i] = vldrhq_s16(pCoeffs + 8 * i);                                                              \
                                                                                                                                                     \
        /*                                                                                       \
...
static void arm_fir_q15_25_32_mve(const arm_fir_instance_q15* S, const q15_t* __restrict pSrc, q15_t* __restrict pDst, uint32_t blockSize) {
#define NBTAPS 32
...
static void arm_fir_q15_17_24_mve(const arm_fir_instance_q15* S, const q15_t* __restrict pSrc, q15_t* __restrict pDst, uint32_t blockSize) {
#define NBTAPS 24
#define NBVECTAPS (NBTAPS / 8)
    FIR_Q15_MAIN_CORE();
#undef NBVECTAPS
...
static void arm_fir_q15_9_16_mve(const arm_fir_instance_q15* S, const q15_t* __restrict pSrc, q15_t* __restrict pDst, uint32_t blockSize) {
#define NBTAPS 16
#define NBVECTAPS (NBTAPS / 8)
    FIR_Q15_MAIN_CORE();
#undef NBVECTAPS
...
static void arm_fir_q15_1_8_mve(const arm_fir_instance_q15* S, const q15_t* __restrict pSrc, q15_t* __restrict pDst, uint32_t blockSize) {
#define NBTAPS 8
#define NBVECTAPS (NBTAPS / 8)
    FIR_Q15_MAIN_CORE();
#undef NBVECTAPS
