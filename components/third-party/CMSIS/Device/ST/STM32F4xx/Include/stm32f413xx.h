...
#define IS_DFSDM_FILTER_ALL_INSTANCE(INSTANCE)                                                                                                       \
    (((INSTANCE) == DFSDM1_Filter0) || ((INSTANCE) == DFSDM1_Filter1) || ((INSTANCE) == DFSDM2_Filter0) || ((INSTANCE) == DFSDM2_Filter1) ||         \
     ((INSTANCE) == DFSDM2_Filter2) || ((INSTANCE) == DFSDM2_Filter3))

#define IS_DFSDM_CHANNEL_ALL_INSTANCE(INSTANCE)                                                                                                      \
    (((INSTANCE) == DFSDM1_Channel0) || ((INSTANCE) == DFSDM1_Channel1) || ((INSTANCE) == DFSDM1_Channel2) || ((INSTANCE) == DFSDM1_Channel3) ||     \
     ((INSTANCE) == DFSDM2_Channel0) || ((INSTANCE) == DFSDM2_Channel1) || ((INSTANCE) == DFSDM2_Channel2) || ((INSTANCE) == DFSDM2_Channel3) ||     \
     ((INSTANCE) == DFSDM2_Channel4) || ((INSTANCE) == DFSDM2_Channel5) || ((INSTANCE) == DFSDM2_Channel6) || ((INSTANCE) == DFSDM2_Channel7))
/******************************* CRC Instances ********************************/
...
#define IS_GPIO_ALL_INSTANCE(INSTANCE)                                                                                                               \
    (((INSTANCE) == GPIOA) || ((INSTANCE) == GPIOB) || ((INSTANCE) == GPIOC) || ((INSTANCE) == GPIOD) || ((INSTANCE) == GPIOE) ||                    \
     ((INSTANCE) == GPIOF) || ((INSTANCE) == GPIOG) || ((INSTANCE) == GPIOH))
...
#define IS_TIM_INSTANCE(INSTANCE)                                                                                                                    \
    (((INSTANCE) == TIM1) || ((INSTANCE) == TIM2) || ((INSTANCE) == TIM3) || ((INSTANCE) == TIM4) || ((INSTANCE) == TIM5) || ((INSTANCE) == TIM6) || \
     ((INSTANCE) == TIM7) || ((INSTANCE) == TIM8) || ((INSTANCE) == TIM9) || ((INSTANCE) == TIM10) || ((INSTANCE) == TIM11) ||                       \
...
#define IS_UART_HALFDUPLEX_INSTANCE(INSTANCE)                                                                                                        \
    (((INSTANCE) == USART1) || ((INSTANCE) == USART2) || ((INSTANCE) == USART3) || ((INSTANCE) == UART4) || ((INSTANCE) == UART5) ||                 \
     ((INSTANCE) == USART6) || ((INSTANCE) == UART7) || ((INSTANCE) == UART8) || ((INSTANCE) == UART9) || ((INSTANCE) == UART10))
