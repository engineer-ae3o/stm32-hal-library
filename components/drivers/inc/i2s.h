...
#define I2S5 ((I2S_TypeDef*)SPI5)
    ...
    typedef enum : uint8_t { I2S_MODE_PHILIPS = 0b00U, I2S_MODE_LEFT_JUSTIFIED = 0b01U, I2S_MODE_RIGHT_JUSTIFIED = 0b10U } i2s_mode_t;
    ...
    typedef enum : uint8_t { I2S_DIR_HALF_DUPLEX_TX = 0b10U, I2S_DIR_HALF_DUPLEX_RX = 0b11U } i2s_dir_t;
    ...
    // and then the isr is fired on completion, then starts filling B
