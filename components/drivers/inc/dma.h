...
#include <stdbool.h>
    ...
    typedef enum : uint8_t { DMA_DIR_P_M = 0b00U, DMA_DIR_M_P = 0b01U, DMA_DIR_M_M = 0b10U } dma_stream_dir_t;
    ...
    typedef enum : uint8_t { DMA_SIZE_BYTE = 0b00U, DMA_SIZE_HWORD = 0b01U, DMA_SIZE_WORD = 0b10U } dma_data_size_t;
    ...
    static inline hal_err_t dma_isr_helper(DMA_Stream_TypeDef* stream,
                                           volatile uint32_t*  irq_clr_rg,
                                           volatile uint32_t*  irq_sta_rg,
                                           uint32_t            tc,
                                           uint32_t            te,
                                           uint32_t            dme,
                                           uint32_t            ht) {
